(function () {
    ...
    function initIndexPage() {
        ...
        const products = [
            ...
            { id: 3, name: "مطحنة قهوة كهربائية 160 واط", price: 279, oldPrice: 399, image: "/static/images/product-3-grinder.jpg", category: "طحن", rating: 4.9, material: "ستانلس ستيل", dimensions: "10x10x18 سم", size: "سعة 50 جرام", bestSeller: false },
            ...
            { id: 6, name: "مق قهوة ستيل مقاوم للصدا 500مل", price: 95, oldPrice: 129, image: "/static/images/product-6-thermos.jpg", category: "أكواب", rating: 4.7, material: "ستانلس ستيل 304", dimensions: "قطر 7 سم × ارتفاع 22 سم", size: "500 مل", bestSeller: false },
            ...
            { id: 11, name: "ساعة تايمر مغناطيسية للقهوة", price: 26, oldPrice: 55, image: "/static/images/product-11-timer.jpg", category: "أدوات تحضير", rating: 4.3, material: "بلاستيك ABS + مغناطيس", dimensions: "7x7x2 سم", size: "صغير", bestSeller: false },
            { id: 12, name: "حبوب بن شلشلي - 250 جرام", price: 48, oldPrice: 65, image: "/static/images/product-12-beans.jpg", category: "مستهلكات", rating: 4.8, material: "قهوة عضوية 100%", dimensions: "عبوة 250 جرام", size: "تحميص متوسط", bestSeller: true },
